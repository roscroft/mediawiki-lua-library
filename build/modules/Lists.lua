...
local funclib = require('Module:Funclib') -- Imports domain-specific table/column/query functions
-- Note: Module:Mw html extension would be required in MediaWiki context
-- require("Module:Mw html extension")

-- Note: Pure functional programming utilities are now in Module:Functools,
-- which is imported by Module:Funclib internally. This keeps the lists module
-- clean and focused on its specific domain.
...
---@field columns table<number, ColumnConfig> Column configuration
